 ...
 */
public class IronOreActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener, Button.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ironore_calculator);

        findViews();

        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,
                R.array.ironore_materials, android.R.layout.simple_spinner_item);
    ...
    public void onClick(View v) {
        if ( v == btnCalculate ) {
            ...
            if((spinMaterial.getSelectedItem().toString()).equals("Iron Ore from China")){
                new GetMetalPriceFromJSON().execute(
                        "https://www.quandl.com/api/v1/datasets/WSJ/FE_TJN.json?api_key=ATJdzsMvokeryKVx_cnz");
            }
            if((spinMaterial.getSelectedItem().toString()).equals("Iron Ore from Tianjin")){
                new GetMetalPriceFromJSON().execute(
                        "https://www.quandl.com/api/v1/datasets/ODA/PIORECR_USD.json?api_key=ATJdzsMvokeryKVx_cnz");
            }
